...
DFLAGS=-m$(MODEL) -O -release -inline -w -Isrc -Iimport -property -version=Unicode -version=Windows7
UDFLAGS=-m$(MODEL) -O -release -w -Isrc -Iimport -property -version=Unicode -version=Windows7
