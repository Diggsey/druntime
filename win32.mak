...
DFLAGS=-m$(MODEL) -O -release -inline -w -Isrc -Iimport -property -version=Windows7
UDFLAGS=-m$(MODEL) -O -release -w -Isrc -Iimport -property -version=Windows7
DDOCFLAGS=-c -w -o- -Isrc -Iimport -version=Windows7
...
$(IMPDIR)\core\sync\barrier.di : src\core\sync\barrier.d
	$(DMD) -c -o- -Isrc -Iimport -version=Windows7 -Hf$@ $**
